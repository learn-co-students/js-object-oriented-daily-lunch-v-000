...
describe("index.js", () => {
  ...
  describe("Basic Class Properties", () => {
    ...
    beforeEach(() => {
      ...
      secondMeal = new Meal(
        "An entire large stuffed crust pizza from pizza hut",
        20
      );
      ...
      secondDelivery = new Delivery(
        secondMeal.id,
        secondNeighborhood.id,
        secondCustomer.id
      );
      thirdDelivery = new Delivery(
        secondMeal.id,
        secondNeighborhood.id,
        secondCustomer.id
      );
